...
export function TownEnvironment() {
  ...
  return <>
    ...
    <mesh rotation-x={-Math.PI/2} position-y={-.18} receiveShadow><planeGeometry args={[58,50]}/><meshStandardMaterial map={groundTexture ?? undefined} color={TOWN_COLORS.ground} roughness={.94}/></mesh>
